                ...
                <div class="product-details-content">
                    ...
                    <div class="pro-dec-feature">
                        <ul>
                            <?php 
                                    $specsData = new Spec;
                                    $specsData->setProduct_id($_GET['product']);
                                    $specs = $specsData->get()->fetch_all(MYSQLI_ASSOC);
                    ...
                    <div class="pro-dec-categories">
                        <ul>
                            <li class="categories-title"><a
                                    href="shop.php?cat=<?= $product->category_id ?>"><?= $product->category_name_en ?></a>
                            </li>
                            <li><a href="shop.php?sub=<?= $product->subcategory_id ?>"><?= $product->subcategory_name_en ?>
                                    , </a></li>
                ...
                <div id="des-details3" class="tab-pane">
                    <div class="rattings-wrapper">
                        <?php 
                                ...
                                $reviews = $reviewObj->get()->fetch_all(MYSQLI_ASSOC);
